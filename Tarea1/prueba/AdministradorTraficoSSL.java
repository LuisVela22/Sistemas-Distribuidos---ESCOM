...
class AdministradorTraficoSSL {
  ...
  public static void main(String[] args) throws Exception {
    if (args.length != 4) {
      System.out.println("Uso: java AdministradorTraficoSSL <ipServidor1> <puertoServidor1> <ipServidor2> <puertoServidor2>");
      System.exit(1);
    }

    // Asignar las IPs y puertos desde los parámetros de la línea de comandos
    ipServidor1 = args[0];
